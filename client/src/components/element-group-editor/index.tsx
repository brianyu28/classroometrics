...
function ElementGroupEditor({
    ...
    const reorder = (group: Element[], startIndex: number, endIndex: number): Element[] => {
                    ...
                    {(provided, snapshot) => (
                        ...
                        >
                            ...
                            {group.map((element, index) => (
                                <Draggable key={element.id} draggableId={element.id.toString()} index={index} isDragDisabled={group.length <= 1}>
                                {(provided, snapshot) => (
                                  <div
                                    ref={provided.innerRef}
